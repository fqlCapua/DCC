		...
		<div class="data" v-show="selectTab === 0">
			<div id="shareReward">
				...
				<div class="select tabChild1" id="select">
					<div class="select_content">
						...
						<p class="option" @click="selectTabFun(0)" :class="{option_child_active:selectTabChild==0}">決策合夥人</p>
						<p class="option" @click="selectTabFun(1)" :class="{option_child_active:selectTabChild==1}">核心合夥人</p>
						<p class="option" @click="selectTabFun(2)" :class="{option_child_active:selectTabChild==2}">一般合夥人</p>
          ...
          <div class="data" :class="{dataChild:selectTabChild === 1}" v-show="selectTabChild === 1">
              ...
              <div class="add_more" v-show="!userList2.length">暫無獎勵2</div>
				  ...
				  <div class="data" :class="{dataChild:selectTabChild ===2}" v-show="selectTabChild === 2">
            <div class="eleBox">
            ...
            <div class="dataChild_ele" v-for="(item,index) in userList3" :key="index">
             ...
             <div class="add_more" v-show="!userList3.length">暫無獎勵3</div>
              </div>
          </div>
